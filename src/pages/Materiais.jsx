...
function Materiais() {
  return (
    <main className='bg-fundosite font-openSans font-normal text-sm text-text md:flex md:flex-col md:items-center'>
      ...
      <section className='bg-bgcaixa mx-box mb-bottom mt-top px-inline rounded-custom md:flex md:py-desk md:px-desk md:w-with sm:max-w-[47rem]'>
        <div className='flex flex-col items-center md:justify-center md:mr-[2rem]'>
        ...
        <div className='md:flex md:flex-col md:justify-center md:max-w-[30rem]'>
      ...
      <section className='bg-bgcaixa mx-box mb-bottom mt-top px-inline rounded-custom md:flex md:py-desk md:px-desk md:w-[50rem] sm:max-w-[47rem]'>
        <div className='flex flex-col items-center md:justify-center md:mr-[2rem]'>
      ...
      <section className='bg-bgcaixa mx-box mt-top px-inline rounded-custom md:flex md:py-desk md:px-desk md:w-[50rem] sm:max-w-[47rem] md:mb-bottom'>
        <div className='flex flex-col items-center md:justify-center md:mr-[2rem]'>
